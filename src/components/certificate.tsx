            ...
            <div id="certificate-wrapper">
                ...
                <div className="certificate-page w-full max-w-5xl aspect-[297/210] bg-white shadow-lg p-10 border-4 mt-8 flex flex-col" style={{ borderColor: accentColor }}>
                     <div className="relative flex-1 flex flex-col">
                        ...
                        <footer className="relative z-10 pt-4 mt-auto">
                            <div className="flex justify-between items-end">
                                <div className="text-center w-2/5">
                                    <div className="mx-auto w-full h-12 mb-1 border-b-2 border-gray-700"></div>
                                ...
                                <div className="text-center w-2/5">
                                    ...
                                    <hr className="border-gray-700 mt-1 w-full mx-auto"/>
                ...
                <div className="certificate-page w-full max-w-5xl aspect-[297/210] bg-white shadow-lg p-10 border-4 mt-8 flex flex-col" style={{ borderColor: accentColor }}>
                    <div className="relative flex-1 flex flex-col">
                        ...
                        <footer className="relative z-10 pt-4 border-t mt-auto">
                            <div className='flex justify-between items-end'>
