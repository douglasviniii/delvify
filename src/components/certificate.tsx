...
const Certificate: React.FC<CertificateProps> = ({ studentName, studentCpf, courseName, completionDate, courseModules, settings }) => {
    ...
    const handleDownloadPdf = async () => {
        ...
        // Mesmo no celular, usamos os elementos A4 para gerar o PDF
    ...
    return (
         <>
            ...
            {/* Visualização para Desktop e para geração do PDF */}
            ...
            {/* Os elementos do certificado para o PDF, escondidos no mobile */}
            <div className="absolute -left-[9999px] top-auto md:relative md:left-0">
